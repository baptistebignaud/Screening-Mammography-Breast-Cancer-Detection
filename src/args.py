...
datasets = {
    ...
    "inaturalist": ("inaturalist_train", "inaturalist_validation", "inaturalist_test"),
}
...
parser.add_argument("--pos-weight-loss", type=float, default=1, help="weight the positive class in the loss")
